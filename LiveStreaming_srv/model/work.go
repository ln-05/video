...
type VideoWorks struct {
	...
	MusicId        int    `gorm:"column:music_id;type:int;comment:选择音乐;default:NULL;" json:"music_id"`                       // 选择音乐
	...
	CheckUser      int    `gorm:"column:check_user;type:int;comment:审核人;default:NULL;" json:"check_user"`                    // 审核人
	...
	LikeCount      int    `gorm:"column:like_count;type:int;comment:喜欢数量;default:NULL;" json:"like_count"`                   // 喜欢数量
	CommentCount   int    `gorm:"column:comment_count;type:int;comment:评论数;default:NULL;" json:"comment_count"`              // 评论数
	ShareCount     int    `gorm:"column:share_count;type:int;comment:分享数;default:NULL;" json:"share_count"`                  // 分享数
	CollectCount   int    `gorm:"column:collect_count;type:int;comment:收藏数;default:NULL;" json:"collect_count"`              // 收藏数
	BrowseCount    int    `gorm:"column:browse_count;type:int;comment:浏览量;default:NULL;" json:"browse_count"`                // 浏览量
}
